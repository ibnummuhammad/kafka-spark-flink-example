...
public class KafkaProducerExample {
    ...
    public static void main(final String... args) {
        ...
        int EXAMPLE_PRODUCER_INTERVAL = System
                .getenv("EXAMPLE_PRODUCER_INTERVAL") != null
        ...
        try {
            while (true) {
                ...
                logger.info("Sent ({}, {}) to topic {} @ {}.", uuid, word,
                        Commons.EXAMPLE_KAFKA_TOPIC, metadata.timestamp());
